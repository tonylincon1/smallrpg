...
local items = {
          item1 = {11207, 7368}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {11207, 2455} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
