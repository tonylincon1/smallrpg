...
local items = {
          item1 = {10136, 2529}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {8930, 8932} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
...
function creatureSayCallback(cid, type, msg)
          ...
          if msgcontains(msg, 'Medalhao') then
          ...
          elseif msgcontains(msg, 'Emerald Sword') then
