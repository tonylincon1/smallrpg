...
shopModule:addBuyableItem({'instense healing'}, 2265, 95, 10, 'intense healing rune')
...
shopModule:addBuyableItem({'great fireball'}, 2304, 180, 15, 'great fireball rune')
shopModule:addBuyableItem({'explosion'}, 2313, 250, 7, 'explosion rune')
shopModule:addBuyableItem({'sudden death'}, 2268, 350, 6, 'sudden death rune')
shopModule:addBuyableItem({'Heavy Holy Missile'}, 2295, 200, 10, 'Heavy Holy Missile')
...
shopModule:addBuyableItem({'wild growth'}, 2269, 320, 5, 'wild growth rune')
shopModule:addBuyableItem({'convince creature'}, 2290, 80, 10, 'convince creature rune')
shopModule:addBuyableItem({'chameleon'}, 2291, 210, 10, 'chameleon rune')
shopModule:addBuyableItem({'desintegrate'}, 2310, 80,  10, 'desintegreate rune')
...
shopModule:addBuyableItemContainer({'bp sd'}, 2003, 2268, 7000, 6, 'backpack of sudden death')
shopModule:addBuyableItemContainer({'bp uh'}, 2002, 2273, 3500, 3, 'backpack of ultimate healing')
