...
local items = {
          item1 = {11207, 8910}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {11207, 8922} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
