...
local items = {
          item1 = {6120, 2090}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {7963, 7959} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
