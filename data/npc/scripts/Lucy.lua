...
local items = {
          item1 = {12601, 12618}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {12601, 2111} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
...
function creatureSayCallback(cid, type, msg)
          ...
          if msgcontains(msg, 'Square Cap') then
