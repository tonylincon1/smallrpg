...
function creatureSayCallback(cid, type, msg)
        ...
        local table_left_pos = {x = 1110, y = 1120, z = 7} -- Pos da frente do Npc onde gira o dado
        local table_middle_pos = {x = 1110, y = 1119, z = 7} -- Pos do meio onde vai o dinheiro
        ...
        posplayer = {x = 1095, y = 1119, z = 7} -- Pos onde o player precisa estar
