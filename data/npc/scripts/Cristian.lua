...
local items = {
          item1 = {12619, 11368}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {12619, 11368} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
...
function creatureSayCallback(cid, type, msg)
          ...
          if msgcontains(msg, 'Blousm Necklace') then
          ...
          elseif msgcontains(msg, 'Blousm Necklace') then
