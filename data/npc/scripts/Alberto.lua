...
local items = {
          item1 = {8306, 11113}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {8306, 8880} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
          count1 = {20, 1}, -- count1 quantidade que será pedido e que será dado na primeira troca
...
function creatureSayCallback(cid, type, msg)
          ...
          if msgcontains(msg, 'Crystal Boots') then
