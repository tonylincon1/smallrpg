_Lib_Battle_Info = {
Reward = {
exp = {true, 1000000}, items = {true, 2157, 1}, premium_days = {false, 2}
},
TeamOne = {name = "Black Assassins", storage = 140120, pos = {x=927,y=1102,z=7}},
TeamTwo = {name = "Red Barbarians",storage = 140121,pos = {x=976,y=1101,z=7}},
storage_count = 180400,
tpPos = {x=1137, y=891, z=7},
...
local B = {
{6839,{x=951, y=1099, z=7, stackpos = 1}},
{6839,{x=951, y=1100, z=7, stackpos = 1}},
{6839,{x=951, y=1101, z=7, stackpos = 1}},
{6839,{x=951, y=1102, z=7, stackpos = 1}}
}
for i = 1, #B do
