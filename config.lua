...
redSkullLength = 10 * 60 * 1000
blackSkullLength = 20 * 60 * 1000
dailyFragsToRedSkull = 10
weeklyFragsToRedSkull = 70
monthlyFragsToRedSkull = 280
...
maxPlayers = 300
motd = "Bem Vindo ao Small RPG"
displayOnOrOffAtCharlist = false
onePlayerOnlinePerAccount = true
allowClones = true
serverName = "Small RPG"
loginMessage = ".:: Bem Vindo ao Small RPG ::. 8.60.!"
...
mapName = "fdaf"
mapAuthor = "By.:: Antonio e Camiloxx ::."
randomizeTiles = true
...
experienceShareRadiusX = 2000
experienceShareRadiusY = 2000
experienceShareRadiusZ = 2
experienceShareLevelDifference = 2 / 3
extraPartyExperienceLimit = 20
extraPartyExperiencePercent = 5
experienceShareActivity = 1000 * 1000 * 1000
