...
function creatureSayCallback(cid, type, msg)
	...
	elseif talkState[talkUser] == 1 then 
		...
		elseif not doPlayerRemoveItem(cid, exclusives_caves_areas[cave].price.itemid, exclusives_caves_areas[cave].price.amount) then
			talkState[talkUser] = 0 
			npcHandler:say("Desculpe mas você não tem "..exclusives_caves_areas[cave].price.amount.."x "..getItemNameById(exclusives_caves_areas[cave].price.itemid).." Gold's para comprar esta cave.", cid) return true
		end
