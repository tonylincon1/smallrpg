exclusives_caves_areas = { -- adicionar as caves
                       [1] = {name = "Demon Hunter", price = {itemid = 2159, amount = 10}, level = {min = 8, max =30}, time = 4, premium = false, enter = {x = 284, y = 223, z = 7}, from = {x = 275, y = 219, z = 5}, to = {x = 302, y = 240, z = 7}},
                       [2] = {name = "Hydras Thow", price = {itemid = 2160, amount = 100}, level = {min = 10, max = 1000}, time = 3, premium = true, enter = {x = 148, y = 218, z = 7}, from = {x = 137, y = 217, z = 7}, to = {x = 161, y = 234, z = 7}}
                       }
...
exclusives_caves_config = {
                        ...
                        serve_mensagem = "[Exclusive Cave System] A cave %s acabou de ficar liberada para venda por %dx %s, aproveitem para compra-la no NPC!"
                        }
